    ...
    <div className='w-full py-[10rem] px-4 bg-black'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <h2 className='text-2xl font-bold text-center py-8 text-[#755b00]'>Single User</h2>
              <p className='text-center text-4xl font-bold text-[#af8300]'>$149</p>
              <div className='text-center font-medium'>
                  <p className='py-2 border-b mx-8 mt-8 text-white'>Profit 2</p>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <p className='text-center text-4xl font-bold text-[#af8300]'>$149</p>
              <div className='text-center font-medium'>
                  <p className='py-2 border-b mx-8 mt-8 text-white'>Profit 1</p>
                  <p className='py-2 border-b mx-8 text-white'>Profit 2</p>
